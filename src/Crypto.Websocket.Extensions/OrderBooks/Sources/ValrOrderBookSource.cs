...
namespace Crypto.Websocket.Extensions.OrderBooks.Sources
{
    ...
    public class ValrOrderBookSource : OrderBookSourceBase
    {
        ...
        private void HandleSnapshot(AggregatedOrderBookUpdateResponse response)
        {
        ...
        private static OrderBookLevel[] ConvertLevels(AggregatedOrderBookUpdateResponse response)
        {
        ...
        private static OrderBookLevel ConvertLevel(Quote x, CryptoOrderSide side, string pair)
        {
            return new
            (
        ...
        private void FillBulk(AggregatedOrderBookUpdateResponse response, OrderBookLevelBulk bulk)
        {
